...
const ProductEditScreen = ({ match, history }) => {
  ...
  return (
    <div style={{ marginTop: "20px", marginBottom: "50px", padding: "20px" }}>
      <Link to="/admin/productlist" className="btn btn-light mx-3">
        Go Back
      </Link>
            ...
            <Form.Group controlId="category">
              ...
              >
                ...
                {categories.map((category) => (
                  <option key={category._id}>{category.cat}</option>
                ))}
              </Form.Control>
            </Form.Group>
